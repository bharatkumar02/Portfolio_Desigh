...
function About() {
  ...
  return (
    ...
    >
      <span className="text-red-500 uppercase">2+ Year of Experience</span>
      <h2 className="font-[poppins] text-3xl font-semibold md:mb-5">
        About Me
      </h2>

      <div className="mx-auto sticky top-0 md:static z-20 mb-3 flex w-full max-w-[340px] items-center overflow-hidden rounded-lg bg-[linear-gradient(145deg,_#1e2024,_#23272b)] shadow-[10px_10px_19px_#1c1e22,_-10px_-10px_19px_#262a2e] *:cursor-pointer *:lg:py-7 *:lg:text-xl">
        <Button
